    ...
    <section class="services py-5">
        <div class="container py-md-5 py-3">
            <div class="row text-justify">
                <div class="col-1"></div>
                <div class="col-10">
                    <h2 class="mb-4 heading text-center">Create Basic-Upsell</h2>
                    <section class="cd-faq js-cd-faq container max-width-md margin-top-lg margin-bottom-lg">
                        ...
                        <div class="cd-faq__items">
                            ...
                            <div id="product" class="new_block">
                            ...
                            <div id="discount" class="new_block">
                            ...
                            <div id="display" class="new_block">
                            ...
                            <div id="step5" class="new_block">
                                <h2>Step 5: Test popup
                                </h2>
